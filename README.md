...
│   ├── features.py             # Feature engineering pipeline (15 features)
│   ├── models.py               # Model training & hyperparameter search
│   ├── evaluation.py           # Unified metric computation
│   ├── robustness.py           # Learning curves, temporal & subgroup analysis, bootstrap CIs
│   └── analysis.py             # quantDDA() and vizDDA() logic
├── notebooks/
│   └── main.ipynb              # Complete notebook (Phase 1 + Phase 2 + Phase 3)
